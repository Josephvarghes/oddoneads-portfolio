        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredFilms.map((film, idx) => (
            <motion.div
              ...
              className="group relative cursor-pointer overflow-hidden bg-charcoal-900 border border-white/[0.03] flex flex-col"
            >
              {/* Cover Image Frame */}
              <div className="relative aspect-[16/9] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-16 h-16 rounded-full bg-charcoal-950/75 border border-white/10 flex items-center justify-center text-white group-hover:bg-gold-500 group-hover:text-charcoal-950 transition-all duration-300 group-hover:scale-110 shadow-lg group-hover:border-gold-500">
                    <Play size={20} className="fill-current ml-1" />
                  </div>
                </div>

                {/* Duration Badge */}
                <div className="absolute bottom-4 right-4 flex items-center gap-1 bg-black/60 backdrop-blur-sm px-2.5 py-1 text-[10px] tracking-widest uppercase text-white font-semibold border border-white/10">
              ...
              {/* Text Meta Info */}
              <div className="p-6 bg-charcoal-900 border-t border-white/[0.03] flex flex-col justify-between flex-grow">
                <div>
                  <div className="flex items-center gap-1.5 text-[9px] uppercase tracking-widest text-gold-500 font-semibold mb-1">
                    <MapPin size={10} /> {film.location}
                  </div>
                  <h3 className="font-serif text-xl font-medium text-white mb-2 group-hover:text-gold-500 transition-colors">
                    {film.coupleName}
                  </h3>
          ...
          >
            ...
            <div className="absolute top-6 right-6 flex items-center gap-4">
              ...
              <button
                ...
                className="w-10 h-10 border border-white/10 hover:border-gold-500 text-white hover:text-gold-500 flex items-center justify-center transition-colors cursor-pointer rounded-none bg-charcoal-950"
