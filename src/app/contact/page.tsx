      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xs md:text-sm text-charcoal-400 font-light max-w-lg mx-auto leading-relaxed">
            Ready to secure your date? Fill out our luxury consultation planner, and let&apos;s start designing your cinematic keepsake.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div>
              <span className="text-[10px] uppercase tracking-widest text-gold-500 font-semibold mb-2 block">
                Direct Inquiries
              </span>
            ...
            <div className="space-y-4 text-xs font-light">
              {/* Phone Prominent */}
              <div className="bg-charcoal-900 border border-white/[0.04] p-6 flex items-start gap-4">
                <div className="w-10 h-10 bg-gold-500/5 border border-gold-500/10 flex items-center justify-center text-gold-500 flex-shrink-0">
                  <Phone size={16} />
                </div>
                <div>
                  <h4 className="font-serif text-white font-medium text-sm mb-1">Direct Hotline</h4>
                  <a href="tel:+919497381830" className="text-gold-500 hover:text-white transition-colors text-base font-semibold block mt-1 tracking-wider">
                    +91 9497381830
                  </a>
                </div>
              </div>
              ...
              <div className="bg-charcoal-900 border border-white/[0.04] p-6 flex items-start gap-4">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-[11px] text-charcoal-400 mb-4">Chat instantly with our booking coordinator.</p>
                  <a
                    href={waUrl}
                    target="_blank"
          ...
          <div className="lg:col-span-7 bg-charcoal-900 border border-white/[0.04] p-8 md:p-12 relative overflow-hidden">
            
            {/* Header / Sub */}
            <div className="mb-8">
              <span className="text-[9px] uppercase tracking-widest text-gold-500 font-semibold mb-1 block">
                Planner
              </span>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/[0.02] border border-white/[0.08] focus:border-gold-500/50 rounded-none px-4 py-3 text-xs text-white placeholder-charcoal-600 focus:outline-none transition-all font-light"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full bg-charcoal-900 border border-white/[0.08] focus:border-gold-500/50 rounded-none px-4 py-3 text-xs text-white focus:outline-none transition-all cursor-pointer font-light"
                  >
                ...
                <div>
                  <label htmlFor="eventDate" className="block text-[10px] uppercase tracking-widest text-charcoal-400 font-semibold mb-2 flex items-center gap-1.5">
                    <Calendar size={12} className="text-gold-500" /> Event Date
                  </label>
                  <input
                    type="date"
                    id="eventDate"
                    ...
                    onChange={handleInputChange}
                    className="w-full bg-white/[0.02] border border-white/[0.08] focus:border-gold-500/50 rounded-none px-4 py-3 text-xs text-white focus:outline-none transition-all font-light cursor-pointer"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="eventLocation" className="block text-[10px] uppercase tracking-widest text-charcoal-400 font-semibold mb-2 flex items-center gap-1.5">
                    <MapPin size={12} className="text-gold-500" /> Event Location
                  </label>
                  <input
                    type="text"
                    id="eventLocation"
                ...
                <div>
                  <label htmlFor="budgetRange" className="block text-[10px] uppercase tracking-widest text-charcoal-400 font-semibold mb-2 flex items-center gap-1.5">
                    <DollarSign size={12} className="text-gold-500" /> Budget Range
                  </label>
                  <select
                    id="budgetRange"
                    name="budgetRange"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full bg-white/[0.02] border border-white/[0.08] focus:border-gold-500/50 rounded-none px-4 py-3 text-xs text-white placeholder-charcoal-600 focus:outline-none transition-all font-light resize-none leading-relaxed"
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-gold-600 to-gold-500 hover:from-gold-500 hover:to-gold-400 text-charcoal-950 font-semibold uppercase tracking-widest text-xs flex items-center justify-center gap-2 transition-all duration-300 shadow-lg shadow-gold-500/10 cursor-pointer disabled:opacity-50"
              >
                {isSubmitting ? (
            ...
            <AnimatePresence>
              {showSuccess && (
                ...
                >
                  ...
                  >
                    <div className="w-16 h-16 bg-gold-500/10 border border-gold-500/30 rounded-full flex items-center justify-center text-gold-500 mb-6 animate-pulse">
                      <CheckCircle2 size={32} />
                    </div>
                    
                    <span className="text-[10px] tracking-[0.4em] text-gold-500 uppercase font-semibold block mb-2">
                      Request Confirmed
                    </span>
                    ...
                    <p className="text-xs text-charcoal-400 leading-relaxed font-light mb-8">
                      Thank you for sharing your vision with us. Our wedding coordinator will review your planner and contact you via email or phone within 24 hours to schedule a consultation.
                    </p>

                    <button
                      onClick={() => setShowSuccess(false)}
                      className="px-8 py-3 border border-white/10 hover:border-gold-500 text-white hover:text-gold-500 text-xs font-semibold uppercase tracking-widest transition-colors cursor-pointer rounded-none"
                    >
                      Close Planner
                    </button>
                  </motion.div>
